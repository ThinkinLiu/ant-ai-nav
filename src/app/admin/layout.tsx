...
import { LayoutDashboard, Users, FileCheck, BarChart3, ArrowLeft, MessageCircle, UserCheck, Settings, Database } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/traffic-sources', label: '流量数据源', icon: Database },
